            ...
            <div class="card-body px-0 pb-2">
              ...
              <form role="form" class="margen-form" id="GuardarForm">
                <div class="mb-2">
                  ...
                  <select name="tipo_usuario" id="tipo_usuario" class="form-control border">
                  </select>
                </div>
                <div class="mb-2">
                  <label class="form-label" for="descripcion_tipo_usuario">Nombre/s</label>
                  <input type="text" class="form-control border" id="descripcion_tipo_usuario" required>
                </div>
                <div class="mb-2">
                  <label class="form-label" for="tipo_usuario">Apellido/s</label>
