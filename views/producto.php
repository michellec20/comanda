  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white bg-gradient-new active" href="producto.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-new shadow-new border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">AGREGAR PRODUCTOS</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              ...
              <form role="form" enctype="multipart/form-data" class="margen-form" id="GuardarForm">
                ...
                <div class="mb-2">
                  ...
                  <input type="text" class="form-control border" id="precio" required>
                </div>
                <div class="mb-2">
          ...
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="productoTable">
                  <thead>
                    <tr>
